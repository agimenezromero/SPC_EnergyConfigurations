...
from Data.EnergyConfigurations import *
...
#if not os.path.exists(data_folder): os.mkdir(data_folder) It must exists to run the program
...
class Window(QMainWindow): 
	...
	def make_plots(self):
		...
		if self.plot_type.currentText() == 'Head to tail aggregation':
			...
			if N0 % 2 != 0 or Nf % 2 != 0:
				QMessageBox.warning(self, 'Warning!', 'This study should be made with even number of particles!')
